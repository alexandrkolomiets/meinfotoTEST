Feature: Regular user journey with product Canvas, and payment is creditcard

  Scenario: User is available to buy product Canvas

    Given User opens Chrome browser and move to the canvas page of shop meinfoto
    When User click on "upload button" from teaser
